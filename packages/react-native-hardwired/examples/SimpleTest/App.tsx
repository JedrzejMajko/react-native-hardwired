        ...
        <ScrollView
          ...
          <View
            ...
            testID="hardwired">
            {
              <PermanentModule
                name={'TestModule'}
                source={sourceCode('hardwired-loaded')}
              />
            }
            {<TemporaryModule source={sourceCode('hardwired-loaded-2')} />}
          </View>
        </ScrollView>
      </SafeAreaView>
    </Provider>
...
const sourceCode = testID => {
  ...
  exports.default = _default;
    ...
    dependencies: [
      {
        hashes: [
          3005131423557722, 768741022705350, 7780418357498032, 4626156116150689,
        ],
        names: [
